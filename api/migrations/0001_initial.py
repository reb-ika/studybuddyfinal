# Generated by Django 5.2 on 2025-05-02 23:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachments', models.ManyToManyField(blank=True, to='api.resource')),
            ],
        ),
        migrations.CreateModel(
            name='Session',
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.group')),
                ('materials', models.ManyToManyField(blank=True, to='api.resource')),
            ],
        ),
    ]
